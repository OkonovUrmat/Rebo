...
class MyView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        anotherView.anchor(top: topGuide.bottomAnchor, bottom: topGuide.topAnchor, leading: leadingAnchor, trailing: trailingAnchor, padding: .init(top: 0, left: 0, bottom: 15, right: 15))
